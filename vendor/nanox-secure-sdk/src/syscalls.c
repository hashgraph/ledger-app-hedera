...
__attribute__((naked)) void SVC_Call(unsigned int syscall_id, unsigned int * parameters);
__attribute__((naked)) void SVC_Call(__attribute__((unused)) unsigned int syscall_id, __attribute__((unused)) unsigned int * parameters) {
...
void check_api_level ( unsigned int apiLevel ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_check_api_level_ID_OUT) { // force reread, updated by the svc
...
void halt ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_halt_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void nvm_write ( void * dst_adr, void * src_adr, unsigned int src_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_nvm_write_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
unsigned char cx_rng_u8 ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_rng_u8_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
...
unsigned char * cx_rng ( unsigned char * buffer, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_rng_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned char *)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_rng_rfc6979 ( unsigned char * rnd, unsigned int rnd_len, unsigned int hashID, const unsigned char * h1, unsigned int h1_len, const unsigned char * x, unsigned int x_len, const unsigned char * q, unsigned int q_len, unsigned char * V, unsigned int V_len ) 
{
  ...
  SVC_Call(SYSCALL_cx_rng_rfc6979_ID_IN, parameters);
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_rng_rfc6979_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
...
int cx_hash ( cx_hash_t * hash, int mode, const unsigned char * in, unsigned int len, unsigned char * out, unsigned int out_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_hash_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ripemd160_init ( cx_ripemd160_t * hash ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ripemd160_init_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_sha224_init ( cx_sha256_t * hash ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_sha224_init_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_sha256_init ( cx_sha256_t * hash ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_sha256_init_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_hash_sha256 ( const unsigned char * in, unsigned int len, unsigned char * out, unsigned int out_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_hash_sha256_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_sha384_init ( cx_sha512_t * hash ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_sha384_init_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_sha512_init ( cx_sha512_t * hash ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_sha512_init_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_hash_sha512 ( const unsigned char * in, unsigned int len, unsigned char * out, unsigned int out_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_hash_sha512_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_sha3_init ( cx_sha3_t * hash, unsigned int size ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_sha3_init_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_keccak_init ( cx_sha3_t * hash, unsigned int size ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_keccak_init_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_sha3_xof_init ( cx_sha3_t * hash, unsigned int size, unsigned int out_length ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_sha3_xof_init_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_groestl_init ( cx_groestl_t * hash, unsigned int size ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_groestl_init_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_blake2b_init ( cx_blake2b_t * hash, unsigned int out_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_blake2b_init_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_blake2b_init2 ( cx_blake2b_t * hash, unsigned int out_len, unsigned char * salt, unsigned int salt_len, unsigned char * perso, unsigned int perso_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_blake2b_init2_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_hmac_ripemd160_init ( cx_hmac_ripemd160_t * hmac, const unsigned char * key, unsigned int key_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_hmac_ripemd160_init_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_hmac_sha256_init ( cx_hmac_sha256_t * hmac, const unsigned char * key, unsigned int key_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_hmac_sha256_init_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_hmac_sha512_init ( cx_hmac_sha512_t * hmac, const unsigned char * key, unsigned int key_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_hmac_sha512_init_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_hmac ( cx_hmac_t * hmac, int mode, const unsigned char * in, unsigned int len, unsigned char * mac, unsigned int mac_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_hmac_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_hmac_sha512 ( const unsigned char * key, unsigned int key_len, const unsigned char * in, unsigned int len, unsigned char * mac, unsigned int mac_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_hmac_sha512_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_hmac_sha256 ( const unsigned char * key, unsigned int key_len, const unsigned char * in, unsigned int len, unsigned char * mac, unsigned int mac_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_hmac_sha256_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
void cx_pbkdf2_sha512 ( const unsigned char * password, unsigned short passwordlen, unsigned char * salt, unsigned short saltlen, unsigned int iterations, unsigned char * out, unsigned int outLength ) 
{
  ...
  SVC_Call(SYSCALL_cx_pbkdf2_sha512_ID_IN, parameters);
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_pbkdf2_sha512_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
int cx_des_init_key ( const unsigned char * rawkey, unsigned int key_len, cx_des_key_t * key ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_des_init_key_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_des_iv ( const cx_des_key_t * key, int mode, const unsigned char * iv, unsigned int iv_len, const unsigned char * in, unsigned int in_len, unsigned char * out, unsigned int out_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_des_iv_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_des ( const cx_des_key_t * key, int mode, const unsigned char * in, unsigned int in_len, unsigned char * out, unsigned int out_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_des_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_aes_init_key ( const unsigned char * rawkey, unsigned int key_len, cx_aes_key_t * key ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_aes_init_key_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_aes_iv ( const cx_aes_key_t * key, int mode, const unsigned char * iv, unsigned int iv_len, const unsigned char * in, unsigned int in_len, unsigned char * out, unsigned int out_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_aes_iv_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_aes ( const cx_aes_key_t * key, int mode, const unsigned char * in, unsigned int in_len, unsigned char * out, unsigned int out_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_aes_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_rsa_init_public_key ( const unsigned char * exponent, unsigned int exponent_len, const unsigned char * modulus, unsigned int modulus_len, cx_rsa_public_key_t * key ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_rsa_init_public_key_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_rsa_init_private_key ( const unsigned char * exponent, unsigned int exponent_len, const unsigned char * modulus, unsigned int modulus_len, cx_rsa_private_key_t * key ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_rsa_init_private_key_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_rsa_generate_pair ( unsigned int modulus_len, cx_rsa_public_key_t * public_key, cx_rsa_private_key_t * private_key, const unsigned char * pub_exponent, unsigned int exponent_len, const unsigned char * externalPQ ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_rsa_generate_pair_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_rsa_sign ( const cx_rsa_private_key_t * key, int mode, cx_md_t hashID, const unsigned char * hash, unsigned int hash_len, unsigned char * sig, unsigned int sig_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_rsa_sign_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_rsa_verify ( const cx_rsa_public_key_t * key, int mode, cx_md_t hashID, const unsigned char * hash, unsigned int hash_len, const unsigned char * sig, unsigned int sig_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_rsa_verify_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_rsa_encrypt ( const cx_rsa_public_key_t * key, int mode, cx_md_t hashID, const unsigned char * mesg, unsigned int mesg_len, unsigned char * enc, unsigned int enc_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_rsa_encrypt_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_rsa_decrypt ( const cx_rsa_private_key_t * key, int mode, cx_md_t hashID, const unsigned char * mesg, unsigned int mesg_len, unsigned char * dec, unsigned int dec_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_rsa_decrypt_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ecfp_is_valid_point ( cx_curve_t curve, const unsigned char * P, unsigned int P_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ecfp_is_valid_point_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ecfp_is_cryptographic_point ( cx_curve_t curve, const unsigned char * P, unsigned int P_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ecfp_is_cryptographic_point_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ecfp_add_point ( cx_curve_t curve, unsigned char * R, const unsigned char * P, const unsigned char * Q, unsigned int X_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ecfp_add_point_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ecfp_scalar_mult ( cx_curve_t curve, unsigned char * P, unsigned int P_len, const unsigned char * k, unsigned int k_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ecfp_scalar_mult_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ecfp_init_public_key ( cx_curve_t curve, const unsigned char * rawkey, unsigned int key_len, cx_ecfp_public_key_t * key ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ecfp_init_public_key_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ecfp_init_private_key ( cx_curve_t curve, const unsigned char * rawkey, unsigned int key_len, cx_ecfp_private_key_t * pvkey ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ecfp_init_private_key_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ecfp_generate_pair ( cx_curve_t curve, cx_ecfp_public_key_t * pubkey, cx_ecfp_private_key_t * privkey, int keepprivate ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ecfp_generate_pair_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ecfp_generate_pair2 ( cx_curve_t curve, cx_ecfp_public_key_t * pubkey, cx_ecfp_private_key_t * privkey, int keepprivate, cx_md_t hashID ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ecfp_generate_pair2_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ecschnorr_sign ( const cx_ecfp_private_key_t * pvkey, int mode, cx_md_t hashID, const unsigned char * msg, unsigned int msg_len, unsigned char * sig, unsigned int sig_len, unsigned int * info ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ecschnorr_sign_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ecschnorr_verify ( const cx_ecfp_public_key_t * pukey, int mode, cx_md_t hashID, const unsigned char * msg, unsigned int msg_len, const unsigned char * sig, unsigned int sig_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ecschnorr_verify_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
void cx_edward_compress_point ( cx_curve_t curve, unsigned char * P, unsigned int P_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_edward_compress_point_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void cx_edward_decompress_point ( cx_curve_t curve, unsigned char * P, unsigned int P_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_edward_decompress_point_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void cx_eddsa_get_public_key ( const cx_ecfp_private_key_t * pvkey, cx_md_t hashID, cx_ecfp_public_key_t * pukey, unsigned char * a, unsigned int a_len, unsigned char * h, unsigned int h_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_eddsa_get_public_key_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
int cx_eddsa_sign ( const cx_ecfp_private_key_t * pvkey, int mode, cx_md_t hashID, const unsigned char * hash, unsigned int hash_len, const unsigned char * ctx, unsigned int ctx_len, unsigned char * sig, unsigned int sig_len, unsigned int * info ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_eddsa_sign_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_eddsa_verify ( const cx_ecfp_public_key_t * pukey, int mode, cx_md_t hashID, const unsigned char * hash, unsigned int hash_len, const unsigned char * ctx, unsigned int ctx_len, const unsigned char * sig, unsigned int sig_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_eddsa_verify_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ecdsa_sign ( const cx_ecfp_private_key_t * pvkey, int mode, cx_md_t hashID, const unsigned char * hash, unsigned int hash_len, unsigned char * sig, unsigned int sig_len, unsigned int * info ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ecdsa_sign_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ecdsa_verify ( const cx_ecfp_public_key_t * pukey, int mode, cx_md_t hashID, const unsigned char * hash, unsigned int hash_len, const unsigned char * sig, unsigned int sig_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ecdsa_verify_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_ecdh ( const cx_ecfp_private_key_t * pvkey, int mode, const unsigned char * P, unsigned int P_len, unsigned char * secret, unsigned int secret_len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_ecdh_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned short cx_crc16 ( const void * buffer, size_t len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_crc16_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
...
unsigned short cx_crc16_update ( unsigned short crc, const void * buffer, size_t len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_crc16_update_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned short)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_math_cmp ( const unsigned char * a, const unsigned char * b, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_cmp_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_math_is_zero ( const unsigned char * a, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_is_zero_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_math_add ( unsigned char * r, const unsigned char * a, const unsigned char * b, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_add_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
int cx_math_sub ( unsigned char * r, const unsigned char * a, const unsigned char * b, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_sub_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
void cx_math_mult ( unsigned char * r, const unsigned char * a, const unsigned char * b, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_mult_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void cx_math_addm ( unsigned char * r, const unsigned char * a, const unsigned char * b, const unsigned char * m, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_addm_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void cx_math_subm ( unsigned char * r, const unsigned char * a, const unsigned char * b, const unsigned char * m, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_subm_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void cx_math_multm ( unsigned char * r, const unsigned char * a, const unsigned char * b, const unsigned char * m, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_multm_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void cx_math_powm ( unsigned char * r, const unsigned char * a, const unsigned char * e, unsigned int len_e, const unsigned char * m, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_powm_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void cx_math_modm ( unsigned char * v, unsigned int len_v, const unsigned char * m, unsigned int len_m ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_modm_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void cx_math_invprimem ( unsigned char * r, const unsigned char * a, const unsigned char * m, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_invprimem_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void cx_math_invintm ( unsigned char * r, unsigned long int a, const unsigned char * m, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_invintm_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
int cx_math_is_prime ( const unsigned char * p, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_is_prime_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (int)(((volatile unsigned int*)parameters)[1]);
}
...
void cx_math_next_prime ( unsigned char * n, unsigned int len ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_math_next_prime_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void os_perso_erase_all ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_perso_erase_all_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void os_perso_set_pin ( unsigned int identity, unsigned char * pin, unsigned int length ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_perso_set_pin_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void os_perso_set_current_identity_pin ( unsigned char * pin, unsigned int length ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_perso_set_current_identity_pin_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void os_perso_set_seed ( unsigned int identity, unsigned int algorithm, unsigned char * seed, unsigned int length ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_perso_set_seed_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void os_perso_derive_and_set_seed ( unsigned char identity, const char * prefix, unsigned int prefix_length, const char * passphrase, unsigned int passphrase_length, const char * words, unsigned int words_length ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_perso_derive_and_set_seed_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void os_perso_set_words ( const unsigned char * words, unsigned int length ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_perso_set_words_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void os_perso_finalize ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_perso_finalize_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
unsigned int os_perso_isonboarded ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_perso_isonboarded_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
...
void os_perso_derive_node_bip32 ( cx_curve_t curve, const unsigned int * path, unsigned int pathLength, unsigned char * privateKey, unsigned char * chain ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_perso_derive_node_bip32_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void os_perso_derive_node_bip32_seed_key ( unsigned int mode, cx_curve_t curve, const unsigned int * path, unsigned int pathLength, unsigned char * privateKey, unsigned char * chain, unsigned char * seed_key, unsigned int seed_key_length ) 
{
  ...
  SVC_Call(SYSCALL_os_perso_derive_node_bip32_seed_key_ID_IN, parameters);
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_perso_derive_node_bip32_seed_key_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
unsigned int os_endorsement_get_code_hash ( unsigned char * buffer ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_endorsement_get_code_hash_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_endorsement_get_public_key ( unsigned char index, unsigned char * buffer ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_endorsement_get_public_key_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_endorsement_get_public_key_certificate ( unsigned char index, unsigned char * buffer ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_endorsement_get_public_key_certificate_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_endorsement_key1_get_app_secret ( unsigned char * buffer ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_endorsement_key1_get_app_secret_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_endorsement_key1_sign_data ( unsigned char * src, unsigned int srcLength, unsigned char * signature ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_endorsement_key1_sign_data_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_endorsement_key2_derive_sign_data ( unsigned char * src, unsigned int srcLength, unsigned char * signature ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_endorsement_key2_derive_sign_data_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_global_pin_is_validated ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_global_pin_is_validated_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_global_pin_check ( unsigned char * pin_buffer, unsigned char pin_length ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_global_pin_check_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
void os_global_pin_invalidate ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_global_pin_invalidate_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
unsigned int os_global_pin_retries ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_global_pin_retries_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_registry_count ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_registry_count_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
void os_registry_get ( unsigned int index, application_t * out_application_entry ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_registry_get_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
unsigned int os_ux ( bolos_ux_params_t * params ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_ux_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
void os_ux_result ( bolos_ux_params_t * params ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_ux_result_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void os_ux_read_parameters ( bolos_ux_params_t * params ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_ux_read_parameters_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void os_lib_call ( unsigned int * call_parameters ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_lib_call_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void os_lib_end ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_lib_end_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void os_lib_throw ( unsigned int exception ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_lib_throw_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
unsigned int os_flags ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_flags_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_version ( unsigned char * version, unsigned int maxlength ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_version_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_serial ( unsigned char * serial, unsigned int maxlength ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_serial_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_seph_serial ( unsigned char * serial, unsigned int maxlength ) 
{
  ...
  parameters[0] = (unsigned int)serial;
  parameters[1] = (unsigned int)maxlength;
  SVC_Call(SYSCALL_os_seph_serial_ID_IN, parameters);
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_seph_serial_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_seph_features ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_seph_features_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_seph_version ( unsigned char * version, unsigned int maxlength ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_seph_version_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_setting_get ( unsigned int setting_id, unsigned char * value, unsigned int maxlen ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_setting_get_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
void os_setting_set ( unsigned int setting_id, unsigned char * value, unsigned int length ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_setting_set_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void os_get_memory_info ( meminfo_t * meminfo ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_get_memory_info_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
unsigned int os_registry_get_tag ( unsigned int appidx, unsigned int * tlvoffset, unsigned int tag, unsigned int value_offset, void * buffer, unsigned int maxlength ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_registry_get_tag_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_registry_get_current_app_tag ( unsigned int tag, unsigned char * buffer, unsigned int maxlen ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_registry_get_current_app_tag_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_sched_exec ( unsigned int application_index ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_sched_exec_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
void os_sched_exit ( unsigned int exit_code ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_sched_exit_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}

unsigned int os_sched_is_running ( unsigned int task_idx ) 
{
  unsigned int parameters [2+1];
  parameters[0] = (unsigned int)task_idx;
  SVC_Call(SYSCALL_os_sched_is_running_ID_IN, parameters);
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_sched_is_running_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}

void os_sched_yield ( unsigned int status ) 
{
  unsigned int parameters [2+1];
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_sched_yield_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}

void os_sched_switch ( unsigned int task_idx, unsigned int status ) 
{
  unsigned int parameters [2+2];
  parameters[0] = (unsigned int)task_idx;
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_sched_switch_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
unsigned int os_sched_create ( unsigned int permissions, void * main, void * nvram, unsigned int nvram_length, void * ram0, unsigned int ram0_length, void * ram1, unsigned int ram1_length, void * stack, unsigned int stack_length ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_sched_create_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
void os_sched_kill ( unsigned int taskidx ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_sched_kill_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void screen_clear ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_screen_clear_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void screen_update ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_screen_update_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void screen_set_keepout ( unsigned int x, unsigned int y, unsigned int width, unsigned int height ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_screen_set_keepout_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void bagl_hal_draw_bitmap_within_rect ( int x, int y, unsigned int width, unsigned int height, unsigned int color_count, const unsigned int * colors, unsigned int bit_per_pixel, const unsigned char * bitmap, unsigned int bitmap_length_bits ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_bagl_hal_draw_bitmap_within_rect_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void bagl_hal_draw_rect ( unsigned int color, int x, int y, unsigned int width, unsigned int height ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_bagl_hal_draw_rect_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
void io_seph_send ( const unsigned char * buffer, unsigned short length ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_io_seph_send_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
unsigned int io_seph_is_status_sent ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_io_seph_is_status_sent_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned short io_seph_recv ( unsigned char * buffer, unsigned short maxlength, unsigned int flags ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_io_seph_recv_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned short)(((volatile unsigned int*)parameters)[1]);
}
...
void nvm_write_page ( unsigned char * page_adr ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_nvm_write_page_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
}
...
try_context_t * try_context_get ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_try_context_get_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
...
try_context_t * try_context_set ( try_context_t * context ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_try_context_set_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (try_context_t *)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int cx_rng_u32 ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_cx_rng_u32_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}

unsigned int os_sched_last_status ( unsigned int task_idx ) 
{
  unsigned int parameters [2+1];
  parameters[0] = (unsigned int)task_idx;
  __asm volatile("mov r0, %1\n"
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_sched_last_status_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_sched_current_task ( void ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_sched_current_task_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_mpu_protect_ram ( unsigned int state ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_mpu_protect_ram_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int os_mpu_protect_flash ( unsigned int state ) 
{
  ...
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_os_mpu_protect_flash_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
...
unsigned int io_button_read ( void ) 
{
  ...
  __asm volatile("mov r0, %1\n"
                 "mov r1, %0\n"
                 "svc #1"::"r"(parameters),"r"(SYSCALL_io_button_read_ID_IN):"r0","r1");
  if (((volatile unsigned int*)parameters)[0] != SYSCALL_io_button_read_ID_OUT) { // force reread, updated by the svc
    THROW(EXCEPTION_SECURITY);
  }
  return (unsigned int)(((volatile unsigned int*)parameters)[1]);
}
